...
#     for row, mask, vid_row in zip(batch.src, batch.src_mask, vid):
#       out = greedy_decode(model, row.unsqueeze(0), mask.unsqueeze(0), 60, 2, vid_row.unsqueeze(0))
#       print(sp_en.decode(row.tolist()), '->', sp_zh.decode(out.tolist()))
