...
model.load_state_dict(torch.load(f'../../compute/models/vatex-clip/{model_type}/{prefix}vatex_{suffix}',map_location=torch.device('cpu')))

test_dataset = VaTeXDataset([f'{prefix}clip_vatex_test.json'], tokenizer)
...
run_inference(
    ...
    save_path = f'../../compute/data/outputs/vatex-clip/{model_type}/{prefix}vatex_{suffix}/'
)
