...
MODEL_DIR = '../../compute/models/text-only/masked_run1/'
MODEL_SAVE = 'best_model-22.pt'
...
model = TransformerModel(SOURCE_VOCAB_SIZE, TARGET_VOCAB_SIZE, N=NUMBER_OF_LAYERS, video_emb_size=VIDEO_EMB_SIZE)
