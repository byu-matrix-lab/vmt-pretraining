...
data_folder = '../../compute/vatex_baseline/Video-guided-Machine-Translation/results/mask_15_end/'

outputf = data_folder + 'submission.json'

compf = '../../compute/vatex_baseline/Video-guided-Machine-Translation/data/mask_15_end_vatex_test.json'
